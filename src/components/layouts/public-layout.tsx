...
export function PublicLayout({ children }: PublicLayoutProps) {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-16 items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            <Link
              to="/"
              className={`text-sm font-medium transition-colors hover:text-[var(--primarybg)] ${
                isActive('/') ? 'text-[var(--primarybg)]' : 'text-[var(--font-light2)]'
              }`}
            >
              Home
            </Link>
            <Link
              to="/about"
              className={`text-sm font-medium transition-colors hover:text-[var(--primarybg)] ${
                isActive('/about') ? 'text-[var(--primarybg)]' : 'text-[var(--font-light2)]'
              }`}
            >
              About Us
            </Link>
            <Link
              to="/contact"
              className={`text-sm font-medium transition-colors hover:text-[var(--primarybg)] ${
                isActive('/contact') ? 'text-[var(--primarybg)]' : 'text-[var(--font-light2)]'
              }`}
            >
              Contact Us
            </Link>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t py-4 bg-background">
            <div className="container flex flex-col space-y-3">
              <Link
                to="/"
                className={`text-sm font-medium py-2 transition-colors hover:text-[var(--primarybg)] ${
                  isActive('/') ? 'text-[var(--primarybg)]' : 'text-[var(--font-light2)]'
                }`}
      ...
      {/* Footer */}
      <footer className="py-8 border-t bg-[var(--cardbg)]">
        <div className="container grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="text-sm text-[var(--font-light2)] mb-4">
              Providing quality education and learning resources for students
              and teachers worldwide.
            </p>
          </div>

          <div>
            <h3 className="font-medium text-base mb-3 text-[var(--font-dark)]">
              Quick Links
            </h3>
            <ul className="space-y-2">
              <li>
                <Link
                  to="/"
                  className="text-sm text-[var(--font-light2)] hover:text-[var(--primarybg)] transition-colors"
                >
                  Home
                </Link>
              </li>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-[var(--font-light2)] hover:text-[var(--primarybg)]">
                <svg
                  className="h-5 w-5"
                  fill="currentColor"
                  viewBox="0 0 24 24"
              ...
              <a href="#" className="text-[var(--font-light2)] hover:text-[var(--primarybg)]">
                ...
                >
                  ...
                  0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118
                  4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993
                  3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072
                  4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095
                  0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616
              ...
              <a href="#" className="text-[var(--font-light2)] hover:text-[var(--primarybg)]">
                ...
                >
                  <path
                    ...
                    4.902 0 011.772 1.153 4.902 4.902 0 011.153 1.772c.247.636.416 1.363.465
                    2.427.048 1.067.06 1.407.06 4.123v.08c0 2.643-.012 2.987-.06 4.043-.049
                    1.064-.218 1.791-.465 2.427a4.902 4.902 0 01-1.153 1.772 4.902 4.902
                    ...
                    0 01-1.772-1.153 4.902 4.902 0 01-1.153-1.772c-.247-.636-.416-1.363-.465-2.427-.047-1.024-.06-1.379-.06-3.808v-.63c0-2.43.013-2.784.06-3.808.049-1.064.218-1.791.465-2.427a4.902
                    ...
                    6.865a5.135 5.135 0 110 10.27 5.135 5.135 0 010-10.27zm0 1.802a3.333 3.333
                    0 100 6.666 3.333 3.333 0 000-6.666zm5.338-3.205a1.2 1.2 0 110 2.4 1.2 1.2
                    0 010-2.4z"
                    clipRule="evenodd"
                  />
                </svg>
        ...
        <div className="container mt-8 pt-8 border-t">
          <p className="text-center text-sm text-[var(--font-light2)]">
