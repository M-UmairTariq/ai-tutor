...
//   type: "sent" | "received";
//   feedback?: any;
//   audioUrl?: string;    // For RECEIVED audio from the server
//   audioURL?: string;    // For SENT audio created locally (Blob URL)
//   audioPlayed?: boolean;
//   hasFeedback?: boolean;
//   hasAssessment?: boolean;
//   assessments?: any;
...
const ChatWindow: React.FC<ChatWindowProps> = ({
  ...
  // --- AUTOPLAY FIX: The logic here is now corrected ---
  useEffect(() => {
    const audioMsg = messages.find(
      (msg) => msg.type === "received" && msg.audioUrl && !msg.audioPlayed
    );

    // The mandatory `isAudioContextUnlocked` check has been removed to allow play attempts on all devices.
